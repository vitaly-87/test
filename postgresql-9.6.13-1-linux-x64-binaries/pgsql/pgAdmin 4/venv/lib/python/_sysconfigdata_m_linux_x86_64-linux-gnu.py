...
build_time_vars = {'ABIFLAGS': 'm',
 ...
 'BLDSHARED': 'gcc -pthread -shared -L/opt/local/Current/lib '
              '-L/opt/local/Current/lib',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 ...
 'CFLAGS': '-Wsign-compare -DNDEBUG -g -fwrapv -O3 -Wall '
           '-I/opt/local/Current/include -I/opt/local/Current/include/ncurses '
           '-I/opt/local/Current/include -I/opt/local/Current/include/ncurses',
 ...
 'CONFIGFILES': 'configure configure.ac acconfig.h pyconfig.h.in '
                'Makefile.pre.in',
 'CONFIGURE_CFLAGS': '-I/opt/local/Current/include '
                     '-I/opt/local/Current/include/ncurses',
 'CONFIGURE_CFLAGS_NODIST': '-std=c99 -Wextra -Wno-unused-parameter '
                            '-Wno-missing-field-initializers',
 'CONFIGURE_CPPFLAGS': '-I/opt/local/Current/include '
                       '-I/opt/local/Current/include/ncurses',
 'CONFIGURE_LDFLAGS': '-L/opt/local/Current/lib',
 'CONFIG_ARGS': "'--prefix=/usr/local/Python3' '--with-threads' "
                "'--enable-shared' '--with-system-expat' "
                "'CFLAGS=-I/opt/local/Current/include "
                "-I/opt/local/Current/include/ncurses' "
                "'LDFLAGS=-L/opt/local/Current/lib' "
                "'CPPFLAGS=-I/opt/local/Current/include "
                "-I/opt/local/Current/include/ncurses'",
 'CONFINCLUDEDIR': '/usr/local/Python3/include',
 'CONFINCLUDEPY': '/usr/local/Python3/include/python3.6m',
 'COREPYTHONPATH': ':',
 'COVERAGE_INFO': '/home/buildfarm/Python-3.6.6/coverage.info',
 'COVERAGE_REPORT': '/home/buildfarm/Python-3.6.6/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--no-branch-coverage --title "CPython lcov '
                            'report"',
 'CPPFLAGS': '-I. -I./Include -I/opt/local/Current/include '
             '-I/opt/local/Current/include/ncurses '
 ...
 'LDFLAGS': '-L/opt/local/Current/lib -L/opt/local/Current/lib',
 'LDLAST': '',
 'LDLIBRARY': 'libpython3.6m.so',
 'LDLIBRARYDIR': '',
 'LDSHARED': 'gcc -pthread -shared -L/opt/local/Current/lib '
             '-L/opt/local/Current/lib',
 'LDVERSION': '3.6m',
 'LIBC': '',
 ...
 'PY_CORE_CFLAGS': '-Wsign-compare -DNDEBUG -g -fwrapv -O3 -Wall '
                   ...
                   '-I/opt/local/Current/include/ncurses '
                   '-I/opt/local/Current/include '
                   '-I/opt/local/Current/include/ncurses -std=c99 -Wextra '
                   '-Wno-unused-parameter -Wno-missing-field-initializers -I. '
                   '-I./Include -I/opt/local/Current/include '
                   '-I/opt/local/Current/include/ncurses '
                   '-I/opt/local/Current/include '
                   '-I/opt/local/Current/include/ncurses -fPIC -DPy_BUILD_CORE',
 'PY_CPPFLAGS': '-I. -I./Include -I/opt/local/Current/include '
                '-I/opt/local/Current/include/ncurses '
                '-I/opt/local/Current/include '
                '-I/opt/local/Current/include/ncurses',
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': '-L/opt/local/Current/lib -L/opt/local/Current/lib',
 'Py_DEBUG': 0,
 'Py_ENABLE_SHARED': 1,
 'Py_HASH_ALGORITHM': 0,
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/home/buildfarm/Python-3.6.6:/opt/local/Current/lib',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'LD_LIBRARY_PATH=/home/buildfarm/Python-3.6.6:/opt/local/Current/lib '
               './python',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/home/buildfarm/Python-3.6.6:/opt/local/Current/lib '
 ...
 'abs_builddir': '/home/buildfarm/Python-3.6.6',
 'abs_srcdir': '/home/buildfarm/Python-3.6.6',
